...
<body>
	...
	<section id="section" style="margin-left: 20px; background-color: #409cff; height: 80px;">
		...
		<div>
			<form action='studentCommentUpdate' method="post">
...
(function() {
	...
	if(lq=="0"){
		...
		var test = lq.tfb_feedback;
		var	tfb_feedback = test.replace(/(<br>|<br\/>|<br \/>)/g, '\r\n');
		$("#infoTable").append("<tr><td class='tg-j32n' colspan='5'><textarea name='tfb_feedback' cols='73' rows='8'>"+tfb_feedback+"</textarea></td></tr>");
