		...
		$.ajax({
			...
			beforeSend : function(xhr){
				...
				$("#quizMaterialUploadTbody").append("<tr><td class='muSmall' style='background-color:gray;'><b>교수명&nbsp;</b>"
									 ...
									 + "<input type='text' name='pb_num' value='"+ conum +"' readonly='readonly' style='border-radius: 8px; text-align:center; width:40%;'></td><tr>");
				...
				$("#quizMaterialUploadTbody").append("<tr>"
									 + "<td style='background-color:gray;' colspan='2'><b>&nbsp;퀴즈&nbsp;&nbsp;&nbsp;</b><input type='text' id='pb_pbname' name='pb_pbname' placeholder='퀴즈명'  style='border-radius: 8px; text-align:center; width:80%;'></td>"
				...
				$("#quizMaterialUploadTbody").append("<tr><td colspan='2' style='background-color:gray;'><b>&nbsp;보기<br><span>"
									 ...
									 + "<input type='text' id='dp_pbexm1' class='dp_pbexm' name='dp_pbexm' placeholder='보기를 입력해주세요.' style='border-radius: 8px;'>"
									 + "<input type='hidden' class='dp_pbexmnum' name='dp_pbexmnumSt' value='1'><br>"
									 + "<label for='dp_pbexmnum2'>&nbsp;2번 보기&nbsp;&nbsp;</label>"
									 + "<input type='text' id='dp_pbexm2' class='dp_pbexm' name='dp_pbexm' placeholder='보기를 입력해주세요.' style='border-radius: 8px;'>"
									 + "<input type='hidden' class='dp_pbexmnum' name='dp_pbexmnumSt' value='2'><br>"
									 + "<label for='dp_pbexmnum3'>&nbsp;3번 보기&nbsp;&nbsp;</label>"
									 + "<input type='text' id='dp_pbexm3' class='dp_pbexm' name='dp_pbexm' placeholder='보기를 입력해주세요.' style='border-radius: 8px;'>"
									 + "<input type='hidden' class='dp_pbexmnum' name='dp_pbexmnumSt' value='3'><br>"
									 + "<label for='dp_pbexmnum4'>&nbsp;4번 보기&nbsp;&nbsp;</label>"
									 + "<input type='text' id='dp_pbexm4' class='dp_pbexm' name='dp_pbexm' placeholder='보기를 입력해주세요.' style='border-radius: 8px;'>"
