	...
	<section id="section" style="margin-left: 20px;">
		...
		<div style="width: 1000px; height: 100px; overflow: auto; background-color: #EBF5FF;">
			<div style="width: 120px ; height: 98px; float: left;">
				...
				<b style="font-size: 24px; color: #409cff">&nbsp;문제번호 : </b>
			</div>
...
if(qlist[0].pb_pbchkqz==0){
	$("#cmt").html("<b>"+cl_clname+"  - "+co_name+" 시험문제</b>");
}else{
	$("#cmt").html("<b>"+cl_clname+"  - "+co_name+"   "+qlist[0].pb_num+""+"회차 퀴즈문제</b>");
}
	$("#studid").html("<h3><b>학생 아이디   :  "+qlist[0].pb_id+"</b></h3>");
	
for(var i=0; i<pbmaxnum; i++){
	 $("#pbnum").append("<div style='width: 75px; text-align: center; float: left;'>"+
				"<button class='btn btn-primary' type='button' onclick='pbnumclick("+i+")'><b class='b'>"+(i+1)+"</b></button></div>");
}
