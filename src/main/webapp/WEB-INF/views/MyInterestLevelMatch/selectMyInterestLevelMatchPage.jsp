...
<header>
   ...
   <table class="table table-striped">
      <tr id="boot">
         <td width="150">관심사</td>
         <td width="150">사진</td>
         <td width="250">강좌명|교수명|강의수</td>
         <td width="150">level</td>
         <td width="150">평점</td>
         <td width="150">강의계획서</td>
         <td width="200">수강신청</td>
      </tr>
      <tbody id="tableShow">
      <c:forEach var="Clasc" items="${cList}">
            <tr height="25">
               <td align="center">${Clasc.cl_cc}</td>
               <td align="center"><img src="<c:url value="/upload/${Clasc.pi_pisysname}"/>"width="50px;"/></td>
               <td align="center"><h2>${Clasc.cl_clname}</h2>${Clasc.cl_id}</td>
               <td align="center"><h2>${Clasc.cl_lv}</h2></td>
                 <c:choose>
               ...
               <td align="center"><a href='selectClassEnroll?cl_idnum=${Clasc.cl_idnum}'>수강신청</a></td>
            </tr>
         </c:forEach>
      </tbody>
   </table>
                        ...
                        .ajax({
                           ...
                           success : function(result) {
                              ...
                              for ( var i in result) {
                                 ...
                                 str += "<th><h2>" + result[i].cl_clname+ "</h2>|" + result[i].cl_id+ "|" +result[i].co_num+ "</th>";
                                 str += "<th><h2>" + result[i].cl_lv+ "</h2></th>";
                                 if(result[i].gpa_gpa == 0){
                                     str += "<th><h2>등록된 평점이 없습니다.<h2></th>"
                                  }else{
                                  str += "<th><h2>"+result[i].gpa_gpa+"</h2></th>"
                                  }                                     
                                 str += "<th><a href='goSelectClassReport?cl_idnum="+ result[i].cl_idnum+ "'>강의계획서</th>";
