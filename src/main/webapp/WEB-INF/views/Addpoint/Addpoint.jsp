...
<body>
	...
	<section id="section" style="margin-left: 20px;">
		...
		<div class="point_charge_row">
			<ul>
				<li>
					<div class="point_charge active" name="onechk" value="5000"
				...
				<li>
					<div class="point_charge" name="onechk" value="20000" onclick="selectPoint(this)">
						<div id="pointBox">
							<dd>20,000 Point</dd>
						</div>
				...
				<li>
					<div class="point_charge"  name="onechk" value="50000" onclick="selectPoint(this)">
						<div id="pointBox">
							<dd>50,000 Point</dd>
						</div>
				...
				<li>
					<div class="point_charge"name="onechk"  value="80000" onclick="selectPoint(this)">
						<div id="pointBox">
							<dd>80,000 Point</dd>
						</div>
	...
	</dl><div class="phone_row">
	<h2 id="result_pt"></h2>
	결제하기 버튼을 누르시면 휴대폰 결제 창으로 넘어갑니다.
	</div>
			<div id="boxbox">
				<hr style="width: 500px;">
				<button class="btn btn-danger" style="height: 50px; width: 150px;">충전하기</button>
			</div>
		</form>
	</section>
	<footer>
